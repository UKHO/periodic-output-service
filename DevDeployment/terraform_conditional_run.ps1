...
Write-Host "##vso[task.setvariable variable=BESSStorageConfiguration.ConnectionString;issecret=true]$($terraformOutput.bess_configuration_storage_connection_string)"
