        ...
        private static HostBuilder BuildHostConfiguration()
        {
            ...
            hostBuilder.ConfigureAppConfiguration((hostContext, builder) =>
            {
             ...
             .ConfigureServices((hostContext, serviceCollection) =>
             {
                 ...
                 serviceCollection.AddHttpClient<IFssApiClient, FssApiClient>(client =>
                     {
                         client.BaseAddress = new Uri(configuration["FSSApiConfiguration:BaseUrl"]);
                 ...
                 serviceCollection.AddHttpClient<IEssApiClient, EssApiClient>(client =>
                 {
                 ...
                 serviceCollection.AddScoped<IEssApiClient, EssApiClient>();
                 serviceCollection.AddScoped<IFssApiClient, FssApiClient>();
