...
namespace UKHO.PeriodicOutputService.Fulfilment.UnitTests.Services
{
    ...
    public class FleetManagerServiceTests
    {
        ...
        private FleetManagerService _fakeFleetManagerService;
        ...
        public async Task DoesGetJwtAuthUnpToken_Returns_Token_WhenValidCredentialsPassed()
        {
            ...
            var result = await _fakeFleetManagerService.GetJwtAuthUnpToken();
...
#pragma warning restore NUnit2021 // Incompatible types for EqualTo constraint
        ...
        public async Task DoesGetJwtAuthJwtToken_Returns_Token_WhenValidAccessTokenPassed()
        {
            ...
            var result = await _fakeFleetManagerService.GetJwtAuthJwtToken("JwtAuthUnpAccessToken");
            Assert.That(result, Is.Not.Null);
#pragma warning disable NUnit2021 // Incompatible types for EqualTo constraint
            Assert.That(result, Is.EqualTo("eyJhbGciOiJIUzI1NiIsInR5cCI6I1234212CJ9.VLSE9fRk0ifQ.fd73LguLf_6VBefVQqu0nj8j3dovfUNVeqZDYGZ4567"));
#pragma warning restore NUnit2021 // Incompatible types for EqualTo constraint
        }
        ...
        public async Task DoesGetJwtAuthJwtToken_Returns_403_WhenInvalidAccessTokenPassed()
        {
            ...
            var result = await _fakeFleetManagerService.GetJwtAuthJwtToken("InvalidJwtAuthUnpAccessToken");

            Assert.That(result, Is.EqualTo(""));
        }

        [Test]
        public async Task DoesGetCatalogue_Returns_Xml_WhenValidAccessTokenPassed()
        {
            ...
            var result = await _fakeFleetManagerService.GetCatalogue("JwtAuthJwtAccessToken");
            Assert.That(result, Is.Not.Null);
#pragma warning disable NUnit2021 // Incompatible types for EqualTo constraint
            Assert.That(result, Does.Contain("AR201010"));
#pragma warning restore NUnit2021 // Incompatible types for EqualTo constraint
        }
        ...
        public async Task DoesGetCatalogue_Returns_403_WhenInvalidAccessTokenPassed()
        {
            ...
            var result = await _fakeFleetManagerService.GetCatalogue("InvalidJwtAuthJwtAccessToken");
