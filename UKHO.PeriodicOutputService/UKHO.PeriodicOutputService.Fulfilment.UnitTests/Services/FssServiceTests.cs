...
namespace UKHO.PeriodicOutputService.Fulfilment.UnitTests.Services
{
    ...
    public class FssServiceTests
    {
        ...
        [Test]
        public async Task DoesCreateBatch_Returns_UnAuthorized_If_InValidRequest()
        {
            ...
            string result = await _fssService.CreateBatch("zip");
           ...
           && call.GetArgument<IEnumerable<KeyValuePair<string, object>>>(2).ToDictionary(c => c.Key, c => c.Value)["{OriginalFormat}"].ToString() == "Request to create batch failed at {DateTime} | StatusCode:{StatusCode} | _X-Correlation-ID:{CorrelationId}"
           ).MustHaveHappenedOnceExactly();
        }
        ...
        [Test]
        public async Task DoesAddFileToBatch_Returns_False_If_InValidRequest()
        {
            A.CallTo(() => _fakeFssApiClient.AddFileToBatchAsync(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored, A<long>.Ignored, A<string>.Ignored))
                .Returns(new HttpResponseMessage()
                {
        ...
        [Test]
        public async Task DoesWriteBlockFile_Returns_False_If_InValidRequest()
        {
            A.CallTo(() => _fakeFssApiClient.WriteBlockInFileAsync(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored))
                .Returns(new HttpResponseMessage()
                {
        ...
        [Test]
        public async Task DoesCommitBatch_Returns_False_If_InValidRequest()
        {
            A.CallTo(() => _fakeFssApiClient.CommitBatchAsync(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored))
                .Returns(new HttpResponseMessage()
                {
