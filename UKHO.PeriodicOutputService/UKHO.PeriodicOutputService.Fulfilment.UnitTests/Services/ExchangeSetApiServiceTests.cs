...
namespace UKHO.PeriodicOutputService.Fulfilment.UnitTests.Services
{
    ...
    public class ExchangeSetApiServiceTests
    {
        ...
        public void Setup()
        {
            _fakeExchangeSetApiConfiguration = Options.Create(new ExchangeSetApiConfiguration() { MicrosoftOnlineLoginUrl = "https://test/api", ClientId = "ClientId", TenantId = "TenantId" });
