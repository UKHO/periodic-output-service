...
namespace UKHO.PeriodicOutputService.Fulfilment.UnitTests.Helpers
{
    ...
    public class CommonHelperTests
    {
        ...
        {
            string user1Credentials = CommonHelper.GetBase64EncodedCredentials("User1", "Password1");
        ...
        {
            string extractedAccessToken = CommonHelper.ExtractAccessToken("{\"token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6I1234212CJ9.VLSE9fRk1234.fd73LguLf_6VBefVQqu0nj8j3dovfUNVeqZDYGZ1234\",\"expiration\":\"2022-06-15T16:02:52Z\"}");
