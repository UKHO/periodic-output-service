...
namespace UKHO.PeriodicOutputService.Common.UnitTests.Services
{
    ...
    public class FleetManagerServiceTests
    {
        ...
        public async Task DoesGetJwtAuthUnpToken_Returns_Token_WhenValidCredentialsPassed()
        {
            ...
            A.CallTo(() => _fakeFleetManagerClient.GetJwtAuthUnpToken(A<HttpMethod>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored)).Returns(response);
        ...
        public void DoesGetJwtAuthUnpToken_Returns_403_WhenInvalidCredentialsPassed()
        {
            ...
            Assert.ThrowsAsync<FulfilmentException>(_fleetManagerService.GetJwtAuthUnpToken);
        ...
        public async Task DoesGetCatalogue_Returns_200_WhenValidAccessTokenPassed()
        {
            ...
            A.CallTo(() => _fakeFleetManagerClient.GetCatalogue(A<HttpMethod>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored)).Returns(response);
        ...
        public void DoesGetCatalogue_Returns_403_WhenInvalidAccessTokenPassed()
        {
            ...
            Assert.ThrowsAsync<FulfilmentException>(() => _fleetManagerService.GetCatalogue("InvalidJwtAuthJwtAccessToken"));
